...
public class Main {
    public static void main(String[] args) {
        ...
        // Teste do algoritmo de ordenacao por agitacao
        System.out.println("Sort Agitacao");
        List<Integer> lista5 = gerarLista(lista,10000);
        tempoInicio = System.nanoTime();
        Sorts.insercao(lista5);
        tempoFim = System.nanoTime();
        System.out.println("Tempo (ms) rotina 5: " + (tempoFim - tempoInicio) / 1000000.0);

        // Teste do algoritmo de ordenacao por pente
        System.out.println("Sort Pente");
        List<Integer> lista6 = gerarLista(lista,10000);
        tempoInicio = System.nanoTime();
        Sorts.insercao(lista6);
        tempoFim = System.nanoTime();
